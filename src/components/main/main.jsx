...
const Main = ({ logout }) => {
  ...
  const [fillFace, setFillFace] = useState("#FFF");
  const [fillTwitter, setFillTwitter] = useState("#FFF");
  const [fillPin, setFillPin] = useState("#FFF");
  const [fillInsta, setFillInsta] = useState("#FFF");
  const [fillTube, setFillTube] = useState("#FFF");
            ...
            <li class="footer__social">
              <a href="#" aria-label="Facebook">
                <svg
                  ...
                  width="20"
                  height="20"
                  onMouseOver={() => setFillFace("hsl(136, 65%, 51%)")}
                  onMouseOut={() => setFillFace("#FFF")}
                >
                  <path
                    fill={fillFace}
            ...
            <li class="footer__social">
              <a href="#" aria-label="YouTube">
                <svg
                  ...
                  width="21"
                  height="20"
                  onMouseOver={() => setFillTube("hsl(136, 65%, 51%)")}
                  onMouseOut={() => setFillTube("#FFF")}
                >
                  <path
                    fill={fillTube}
            ...
            <li class="footer__social">
              <a href="#" aria-label="Twitter">
                <svg
                  ...
                  width="21"
                  height="18"
                  onMouseOver={() => setFillTwitter("hsl(136, 65%, 51%)")}
                  onMouseOut={() => setFillTwitter("#FFF")}
                >
                  <path
                    fill={fillTwitter}
            ...
            <li class="footer__social">
              <a href="#" aria-label="Pinterest">
                <svg
                  ...
                  width="20"
                  height="20"
                  onMouseOver={() => setFillPin("hsl(136, 65%, 51%)")}
                  onMouseOut={() => setFillPin("#FFF")}
                >
                  <path
                    fill={fillPin}
            ...
            <li class="footer__social">
              <a href="#" aria-label="Instagram">
                <svg
                  ...
                  width="21"
                  height="20"
                  onMouseOver={() => setFillInsta("hsl(136, 65%, 51%)")}
                  onMouseOut={() => setFillInsta("#FFF")}
                >
                  <path
                    fill={fillInsta}
